...
<div align="center">
  ...
  <h3><b>Live editor</b></h3>
    ...
    <li><a href="https://github.com/Yacoubou-seidou/live_editor.git">Link to the back-end</a></li>
<!-- TABLE OF CONTENTS -->
...
```sh
  git clone https://github.com/Yacoubou-seidou/live_editor_react.git
...
Feel free to check the [issue page](https://github.com/Yacoubou-seidou/live_editor_react/issues).
